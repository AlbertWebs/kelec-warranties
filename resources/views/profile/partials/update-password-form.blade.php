<section x-data="{ showCurrent: false, showNew: false, showConfirm: false }">
    <header class="mb-5 border-b border-gray-100 pb-4">
        <h2 class="text-base font-semibold text-brand-ink">Update password</h2>
        <p class="mt-1 text-sm text-gray-500">Choose a strong password you do not use elsewhere.</p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="space-y-3">
        ...
        <div class="auth-field">
            ...
            <div class="relative">
                ...
                >
                <button type="button" class="absolute inset-y-0 right-0 flex items-center px-2.5 text-gray-400 hover:text-brand-navy" @click="showCurrent = !showCurrent" :aria-label="showCurrent ? 'Hide password' : 'Show password'">
            ...
            <x-input-error :messages="$errors->updatePassword->get('current_password')" class="!mt-0" />
        </div>
        ...
        <div class="grid gap-3 sm:grid-cols-2">
            <div class="auth-field">
                ...
                <div class="relative">
                    ...
                    >
                    <button type="button" class="absolute inset-y-0 right-0 flex items-center px-2.5 text-gray-400 hover:text-brand-navy" @click="showNew = !showNew" :aria-label="showNew ? 'Hide password' : 'Show password'">
                ...
                <x-input-error :messages="$errors->updatePassword->get('password')" class="!mt-0" />
            </div>
            <div class="auth-field">
                ...
                <div class="relative">
                    ...
                    >
                    <button type="button" class="absolute inset-y-0 right-0 flex items-center px-2.5 text-gray-400 hover:text-brand-navy" @click="showConfirm = !showConfirm" :aria-label="showConfirm ? 'Hide password' : 'Show password'">
                ...
                <x-input-error :messages="$errors->updatePassword->get('password_confirmation')" class="!mt-0" />
            </div>
        </div>
